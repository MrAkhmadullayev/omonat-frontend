...
export default function ExpenseReportsPage() {
	...
	} = useSWR(user ? '/expenses/reports' : null, () => expenseApi.getReports(), {
			...
			datasets: [
				{
					...
					hoverBackgroundColor: ['#dc2626', '#d97706'],
					borderWidth: 0,
					cutout: '70%',
				},
			],
				...
				<div className='flex items-center gap-4'>
					...
					<div>
						...
						<p className='text-xs md:text-sm text-muted-foreground font-medium mt-1'>
							Sizning chiqimlaringiz tahlili
						</p>
					</div>
				</div>
			</motion.div>
					...
					<Card className='relative overflow-hidden border-border/50 bg-background/80 backdrop-blur-sm h-full hover:shadow-md transition-shadow'>
						...
						<CardContent>
							...
							<div className='mt-2'>
								...
								>
									<CheckCircle2 className='w-3.5 h-3.5 mr-1.5' /> Barchasi
									muvaffaqiyatli
								</Badge>
							</div>
						</CardContent>
						...
						<CardHeader className='flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/50 pb-4'>
							<div>
								...
								<CardDescription className='text-xs font-medium'>
									Harajatlarning vaqt bo'yicha taqsimlanishi
								</CardDescription>
							</div>
							<Tabs
								value={activePeriod}
				...
				<motion.div variants={itemVariants} className='lg:col-span-3'>
					<Card className='h-full border-border/50 shadow-sm flex flex-col'>
						<CardHeader className='border-b border-border/50 pb-4'>
							...
							<CardDescription className='text-xs font-medium'>
								Naqd va Karta orqali harajatlar ulushi
							</CardDescription>
						</CardHeader>
